...
public class Buscar extends JFrame {
	...
	public void preencherTabelaReservas() {
		//povoar tbela
		List<Reserva> reservaLista = reservaController.listar();
		try {
	...
	public void preencherTabelaHospedes() {
		//povoar tbela
		List<Hospede> hospedeLista = hospedeController.listar();
		try {
			for (Hospede hospede : hospedeLista) {
				modeloHospedes.addRow(new Object[] {
						hospede.getId(), hospede.getNome(), hospede.getSobrenome(), hospede.getDataNascimento(), hospede.getNacionalidade(), hospede.getTelefone(), hospede.getReservaId() 
				});
			}
			tbHospedes = new JTable();
		} catch (Exception e) {
