...
public class ReservasView extends JFrame {
		...
		btnProximo.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (ReservasView.txtDataE.getDate() != null && ReservasView.txtDataS.getDate() != null) {
					...
					registro.setTxtNreserva(reservaController.getIdReserva());
	...
	public void salvarReserva() {
		reservaController.salvar(converteData(txtDataE), converteData(txtDataS), txtValor.getText(), txtFormaPagamento.getSelectedItem().toString());
		JOptionPane.showMessageDialog(contentPane, "Registro Salvo, Número de Reserva: " + reservaController.getIdReserva());
	}
